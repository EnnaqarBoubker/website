...
@section("content-main")
	<main>
		<section id="hero_in" class="courses">
			<div class="wrapper">
				<div class="container">
					<h1 class="fadeInUp"><span></span>قائــمة التداريــب</h1>
				</div>
			</div>
		</section>
		<!--/hero_in-->
				...
				@foreach($formations as $obj)
					<div class="col-xl-4 col-lg-6 col-md-6">
						<div class="box_grid wow">
							<figure>
								<a href="{{ url('details-formation/'.$obj->id.'-'.$obj->titre) }}"><img src="@if ($obj->image_8 !="") {{ asset('assets/formations/'.$obj->image_8) }} @else {{ asset('assets/frontend/img/centre-mikdad.jpg') }} @endif" class="img-fluid" alt="Centre Mikdad {{ $obj->titre }}"></a>
								<div class="price">
									@if($obj->new_prix > 0)
