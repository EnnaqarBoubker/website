...
<head>
    ...
    <title>Agence Mikdad - Administration</title>
            ...
            <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Bookings">
                    <a class="nav-link" href="{{ url('admin/categories') }}">
                        ...
                        <span class="nav-link-text">Gérer Les Catégories</span>
                    </a>
                </li>
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Bookings">
                    <a class="nav-link" href="{{ url('admin/packs') }}">
                        ...
                        <span class="nav-link-text">Gérer Les Packs</span>
                    </a>
                </li>

                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Bookings">
                    <a class="nav-link" href="{{ url('admin/coachs') }}">
                        <i class="fa fa-fw fa-user-secret"></i>
                        <span class="nav-link-text">Gérer Les Coachs</span>
                    </a>
                </li>

                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Bookings">
                    <a class="nav-link" href="{{ url('admin/abonnements') }}">
                        <i class="fa fa-fw fa-money"></i>
                        <span class="nav-link-text">Gérer Les Abonnements</span>
                    </a>
                </li>
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Mon profil">
                    ...
                    <ul class="sidenav-second-level collapse" id="collapseProfile">
                        ...
                        <li>
                            <a href="{{ url('admin/profile') }}">Mon profil</a>
                        </li>
                        <li>
