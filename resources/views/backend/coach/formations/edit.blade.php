...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <form method="post" id="imageupload" action=" {{ url('coach-admin/formations/'. $formation->id) }} " enctype="multipart/form-data" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group text-center">
                                    ...
                                    <input type="text" class="form-control mt-3" name="video" id="video" placeholder="Ajouter lien de video" value="{{ $formation->video }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    @foreach($categories as $cat)
                                        <option @if($formation->categorie_id ==  $cat->id ) selected @endif  value="{{ $cat->id }}">{{ $cat->nom }}</option>
                                    @endforeach
                            ...
                            <div class="col-md-6">
                                ...
                                <label>Nom du formation <span class="required">*</span></label>
                                <input type="text" value="{{ $formation->titre }}" placeholder="Tappez le titre du formation ici..." class="form-control"  required name="titre">
                                @if($errors->get('titre'))
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="type" required class="form-control" id="type">
                                        ...
                                        <option @if($formation->type ==  1 ) selected @endif value="1">Formation Sur Place</option>
                                        <option @if($formation->type ==  2 ) selected @endif value="2">Formation en Ligne</option>
                                        <option @if($formation->type ==  3 ) selected @endif value="3">Formation en Live</option>
                                    </select>
                                </div>
                            </div>
                             ...
                             <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="exemple : الهدف العام للبرنامج"
                                        class="form-control" name="titre6" value="{{ $formation->titre6 }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group text-center">
                                ...
                                <div class="form-group text-center">
                                    ...
                                    <input type="text" class="form-control mt-3" name="video_1" id="video" placeholder="Ajouter lien de video" value="{{ $formation->video_1 }}">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="exemple : الهدف العام للبرنامج"
                                        class="form-control" name="titre3" value="{{ $formation->titre3 }}">
                                </div>
                            </div>
                            <div class="col-md-12" style="display: flex;flex-wrap: wrap;">
                                <div class="col-md-6">
                                    <div class="form-group text-center">
                                        ...
                                        <input type="text" class="form-control mt-3" name="video_3" id="image" placeholder="Ajouter lien de video" value="{{ $formation->video_3 }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group text-center">
                                        <label class="col-12">Video de formation</label>
                                        <input type="text" class="form-control mt-3" name="video_4" id="image" placeholder="Ajouter lien de video" value="{{ $formation->video_4 }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group text-center">
                                        <label class="col-12">Video de formation</label>
                                        <input type="text" class="form-control mt-3" name="video_5" id="image" placeholder="Ajouter lien de video" value="{{ $formation->video_5 }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group text-center">
                                        <label class="col-12">Video de formation</label>
                                        <input type="text" class="form-control mt-3" name="video_6" id="image" placeholder="Ajouter lien de video" value="{{ $formation->video_6 }}">
                                    </div>
                                </div>
                            </div>
                             <div class="col-md-12">
                                   <div class="form-group">
                                        ...
                                        <textarea name="description7" placeholder="Tappez ici une description concerne la formation..." class="form-control"
                                            id="editor7" rows="3">{{ $formation->description7 }}</textarea>
                                    </div>
                                </div>
                             <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="exemple : احجـــــز مقعدك الان"
                                            class="form-control" name="btn_5" value="{{ $formation->btn_5 }}">
                                    </div>
                                </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Titre de section 3</label>
                                    <input type="text" placeholder="exemple : الهدف العام للبرنامج"
                                        class="form-control" name="titre7" value="{{ $formation->titre7 }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="description1" placeholder="Tappez ici une description concerne la formation..." class="form-control"
                                        id="editor1" rows="3">{{ $formation->description1 }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Button N° 2</label>
                                    <input type="text" placeholder="exemple : احجـــــز مقعدك الان"
                                        class="form-control" name="btn_2" value="{{ $formation->btn_2 }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group text-center">
                                ...
                                <div class="form-group text-center">
                                    <label>Une Video presentation </label>
                                    <input type="text" class="form-control mt-3" name="video_2" id="video" placeholder="Ajouter lien de video" value="{{ $formation->video_2 }}">
                                </div>
                                <p><b>Note :</b> entre Image Ou Video</p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="exemple : الهدف العام للبرنامج"
                                        class="form-control" name="titre1" value="{{ $formation->titre1 }}">
                                </div>
                            </div>
                            <div class="col-md-12" style="display: flex;flex-wrap: wrap;">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description2" placeholder="Tappez ici une description concerne la formation..." class="form-control"
                                            id="editor2" rows="3">{{ $formation->description2 }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description3" placeholder="Tappez ici une description concerne la formation..." class="form-control"
                                            id="editor3" rows="3">{{ $formation->description3 }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description4" placeholder="Tappez ici une description concerne la formation..." class="form-control"
                                            id="editor4" rows="3">{{ $formation->description4 }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description5" placeholder="Tappez ici une description concerne la formation..." class="form-control"
                                            id="editor5" rows="3">{{ $formation->description5 }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description8" placeholder="Tappez ici une description concerne la formation..." class="form-control"
                                            id="editor8" rows="3">{{ $formation->description8 }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="exemple : احجـــــز مقعدك الان"
                                            class="form-control" name="btn_3" value="{{ $formation->btn_3 }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Titre de section 2</label>
                                    <input type="text" placeholder="exemple : الهدف العام للبرنامج"
                                        class="form-control" name="titre2" value="{{ $formation->titre2 }}">
                                </div>
                            </div>
                            <div class="col-md-12" style="display: flex;flex-wrap: wrap;">
                                <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description9" placeholder="Tappez ici une description concerne la formation..." class="form-control"
                                            id="editor9" rows="3">{{ $formation->description9 }}</textarea>
                                    </div>
                                </div>
                             <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Button N° 5</label>
                                        <input type="text" placeholder="exemple : احجـــــز مقعدك الان"
                                            class="form-control" name="btn_4" value="{{ $formation->btn_4 }}">
                                    </div>
                                </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Titre de section 3</label>
                                    <input type="text" placeholder="exemple : الهدف العام للبرنامج"
                                        class="form-control" name="titre8" value="{{ $formation->titre8 }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="description6" placeholder="Tappez ici une description concerne la formation..." class="form-control"
                                        id="editor6" rows="3">{{ $formation->description6 }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Button N° 6</label>
                                    <input type="text" placeholder="exemple : احجـــــز مقعدك الان"
                                        class="form-control" name="btn_6" value="{{ $formation->btn_6 }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group text-center">
                                ...
                                <div class="form-group text-center">
                                    <label>Une Video presentation </label>
                                    <input type="text" class="form-control mt-3" name="video_7" id="video" placeholder="Ajouter lien de video" value="{{ $formation->video_7 }}">
                                </div>
                                <p><b>Note :</b> entre Image Ou Video</p>
                            </div>
                           ...
                           <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="exemple : 350 " class="form-control" name="prix"
                                        required value="{{ $formation->prix }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Nouveau Prix /Dhs</label>
                                    <input type="text" placeholder="exemple : 250" class="form-control" name="new_prix" value="{{ $formation->new_prix }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description10" placeholder="Tappez ici une description concerne la formation..." class="form-control"
                                        id="editor10" rows="3">{{ $formation->description10 }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Button N° 6</label>
                                    <input type="text" placeholder="exemple : احجـــــز مقعدك الان"
                                        class="form-control" name="btn_7" value="{{ $formation->btn_7 }}">
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control" name="date" value="{{ $formation->date }}" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Tappez ici l'adresse exact de formation"
                                    name="lieu" class="form-control" value="{{ $formation->lieu }}" >
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                               ...
                               <select name="status" class="form-control" id="status" required>
                                    <option @if($formation->status ==  1 ) selected @endif value="1"> Afficher</option>
                                    <option @if($formation->status ==  0 ) selected @endif value="0"> Non Afficher</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3"></div>
