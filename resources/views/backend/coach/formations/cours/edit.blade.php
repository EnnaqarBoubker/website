...
@section("content")
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <form method="post" id="imageupload" action=" {{ url('coach-admin/formations-courses/'.$cours->id) }} " enctype="multipart/form-data" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group @if($errors->get('titre')) has-error @endif ">
                                ...
                                <input type="text" value="{{ $cours->titre }}" placeholder="Tappez le titre du cours ici..." class="form-control"  required name="titre">
                                @if($errors->get('titre'))
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group radio_input">
                                <label><input type="radio" value="1" @if($cours->type_cours == 1) checked @endif style="width: 25px; height: 22px" required name="type_cours" class="icheck"><strong> Vidéo</strong></label>
                                <label><input type="radio" value="2" @if($cours->type_cours == 2) checked @endif style="width: 25px; height: 22px" required name="type_cours" class="icheck"><strong> Fichier(PDF/WORD/IMAGE)</strong></label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box_general padding_bottom">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="video_name" value="{{ $cours->video_url }}" class="form-control" placeholder="exemple : centre-mikdak-video-testenom.mp4" name="video_name">
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                                        ...
                                        @foreach($obj->chapitres as $ch)
                                            <div class="col-md-4">
                                                <div class="custom-control custom-checkbox">
                                                    <input style="width: 22px; height: 25px;"  @if(test_chours_inchapitre_ByIdcrs_and_Idchp($cours->id,$ch->id)) checked  @endif type="checkbox" id="customCheckbox{{ $obj->id }}_{{ $ch->id }}" name="chapitres[]" value="{{ $ch->id }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control" id="status" required>
                                    <option value="1"  @if($cours->type_cours == 1) checked @endif > Afficher</option>
                                    <option value="0"  @if($cours->type_cours == 0) checked @endif > Non Afficher</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3"></div>
