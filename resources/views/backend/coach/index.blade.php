            ...
            <div class="row">
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card dashboard text-white bg-primary o-hidden h-100">
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="{{ url('coach-admin/demandes') }}">
                ...
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card dashboard text-white bg-info o-hidden h-100">
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="{{ url('coach-admin/commentaires') }}">
                            <span class="float-left">Plus de Détails</span>
                            <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
                ...
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card dashboard text-white bg-success o-hidden h-100">
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="{{ url('coach-admin/messages') }}">
                            <span class="float-left">Plus de Détails</span>
                            <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
                ...
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card dashboard text-white bg-danger o-hidden h-100">
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="{{ url('coach-admin/formations') }}">
                            <span class="float-left">Plus de Détails</span>
                            <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
